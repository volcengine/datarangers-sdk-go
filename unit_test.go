...
func TestAppEventCollect(a *testing.T) {
	...
	SendEventAb(WEB, 10000001, "", "12", "event1", map[string]interface{}{"event1param": 1}, map[string]interface{}{"cuns": 1}, 6936017802184688384)
